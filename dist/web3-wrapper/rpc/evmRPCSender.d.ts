...
export declare class EvmRPCSender extends AbstractRPCSender {
    ...
    executeCallOrSend(rpcInfos: RpcInfo[], rpcProviderFn?: (provider: ArchiveJsonRpcProvider) => Promise<any>, attemptFallback?: boolean, logRpcFailure?: boolean): Promise<any>;
