...
export declare abstract class BlueprintContext {
    ...
    constructor(blueprintKey: string, networkId: number | string, loggingContext: AbstractLoggingContext, metadataStore: MetadataStore, defiPriceApi?: DefiPriceAPIInterface, blockByDateApi?: BlockByDateAPIInterface);
